...
RSpec.describe UsersController, type: :controller do
  ...
  describe "GET #index does not exist" do
    it "does not have a route for #index action" do
  ...
  describe "GET #new does not exist" do
    it "does not have a route for #new action" do
  ...
  describe "POST #create" do
    it "does not have a route for #create action" do
