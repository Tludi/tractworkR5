class Admin::MaterialsController < Admin::AdminController
  ...
  def update
    respond_to do |format|
      if @material.update(material_params)
        format.html { redirect_to admin_materials_path(@material), notice: 'Material was successfully updated.' }
  ...
  def destroy
    @material.destroy
    respond_to do |format|
      format.html { redirect_to admin_materials_url, notice: 'Material was successfully destroyed.' }
